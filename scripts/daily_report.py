...
def disk_usage(path: Path = settings.DATA_DIR):
    p = Path(path)
...
def main():
    ...
    p.add_argument("--out-dir", default=str(settings.DATA_DIR / "reports"), help="Output directory")
    ...
    du = disk_usage(settings.DATA_DIR)
